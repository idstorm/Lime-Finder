...
{
    // 타이틀 이미지 뷰 //
    UIImage *titleImage = [UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"favorites_title_step05" ofType:@"png"]];
...
- (void)checkButtonTouched:(id)sender
{
    ...
    if (button.selected)
    {
        [rootViewController_.itemManageViewController_.itemMutableDictionary_ setObject:@"YES" forKey:@"EncodeSpace"];
    }
    else
    {
